...
<body>
  ...
  <div class="slider text-center fadeIn">
  ...
  <form>
            ...
            <h1>Sign Up</h1>
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="FormFName" placeholder="First Name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="FormLName" placeholder="Last Name">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="FormTitle" placeholder="Title">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="FormSAddress" placeholder="School Address">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="FormSPhone" placeholder="School Phone no.">
                </div>
                <div class="form-group">
                    <input type="email" class="form-control" id="FormEmail" placeholder="Email address">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Membership type selection</label>
                    <select class="form-control" id="exampleFormControlSelect1">
                        <option>Single €20.00 EUR</option>
                        <option>School €30.00 EUR</option>
                        <option>Student €5.00 EUR</option>
                        <option>Retired €5.00 EUR</option>
                    </select>
                </div>
            </form>
  </div>
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.9s">
                  <div class="align-center">
                    ...
                    <h4 class="text-bold">View our Gallery</h4>
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.6s">
                  <div class="align-center">
                    ...
                    <h4 class="text-bold">Become a Member</h4>
                    <p>Lorem ipsum dolor sit amet, mutat graeco volumus ad eam, singulis patrioque comprehensam nam no. Mei cu dicat voluptaria volumus.
                    </p>
                  </div>
                </div>
              ...
              <div class="box-bg">
                <div class="wow bounceInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
                  <div class="align-center">
                    ...
                    <h4 class="text-bold">Keep Informed with Events</h4>
                    <p>Lorem ipsum dolor sit amet, mutat graeco volumus ad eam, singulis patrioque comprehensam nam no. Mei cu dicat voluptaria volumus.
                    </p>
                  </div>
                </div>
