      ...
      <div class="row">
        <nav id="filter" class="col-md-12 text-center">
          <ul>
            ...
            <li><a href="#" class="btn-theme btn-small" data-filter=".webdesign">2021</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".webdesign">2020</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".photography">2019</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".print">2018</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".print">2017</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".print">2016</a></li>
            <li><a href="#" class="btn-theme btn-small" data-filter=".print">2015</a></li>
          </ul>
        </nav>
        <div class="col-md-12">
          <div class="row">
